...
const genChainsFromRuntime = (
    ...
    const celoRpcUrl = runtime.getSetting("CELO_PROVIDER_URL") || "https://forno.celo.org";
    const alfajoresRpcUrl = runtime.getSetting("ALFAJORES_PROVIDER_URL") || "https://alfajores-forno.celo-testnet.org";

    chains["celo"] = WalletProvider.genChainFromName("celo", celoRpcUrl);
    chains["alfajores"] = WalletProvider.genChainFromName("alfajores", alfajoresRpcUrl);
